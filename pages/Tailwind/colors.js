...
function ColorBox({color, shade, hex}){
    return  (
        <>
            ...
            <div className={"w-full h-10 bg-"+(color)+"-"+(shade)+" rounded ring-1 ring-inset ring-black ring-opacity-0"}></div>
            <div className="px-0.5 md:flex md:justify-between md:space-x-2 2xl:space-x-0 2xl:block">
                <div className="w-6 font-medium text-gray-900 dark:text-gray-400">{shade}</div>
        ...
        <div className="flex flex-col space-y-3 text-xs sm:flex-row sm:space-y-0 sm:space-x-4">
            <div className="flex-shrink-0 w-32">
                <div className="flex flex-col justify-center h-10">
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-400">{color}</div>
...
function Colors() {
    return(
        ...
        <Main>
            ...
            <p className="pb-10">Tailwind includes an expertly-crafted default color palette out-of-the-box that is a great starting point if you don`t have your own specific branding in mind.</p>
